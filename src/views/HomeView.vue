<template>
  <div>
    ...
    <section class="hero">
      ...
      <article>
        <h2>... aún podés aprovechar a comprar cosas baratas.</h2>
<p>De paso me ayudás a hacer espacio en mi nueva casa.</p>
...
.grid-item {
  ...
  border-radius: .25rem;
  box-shadow: 2px 1.5px .5rem light-dark(#c664ff, transparent);
